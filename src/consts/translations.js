const translations = {
  en: {
    ...
    // process
    processT1: 'Ethical Farming Practices',
    processD1: 'Our network of local farmers employs sustainable, eco-friendly practices that minimize environmental impact while maximizing nutrition and flavor. We carefully select each partner based on their commitment to organic farming methods and soil health.',
    processT2: 'Quick and Clean Processing',
    processD2: 'Within hours of harvest, our ingredients are carefully processed in our state-of-the-art facilities. This rapid timeline ensures maximum nutrient retention and the freshest possible flavors in every meal we prepare.',
    processT3: 'Eco-Friendly Packaging & Delivery',
    processD3: 'We\'ve revolutionized our delivery process with 100% compostable packaging and carbon-neutral delivery routes. Our innovative cooling technology keeps food fresh while minimizing environmental impact.',
    processT4: 'Fresh, Delicious Meals',
    processD4: 'The culmination of our process results in nutritious, chef-crafted meals that don\'t just taste good – they\'re good for you and the planet. Each dish is thoughtfully created to provide a perfect balance of flavors and nutrients.',
    ...
    pw: 'Password',
    whySI: 'Why Sign In?',
    whySIHelp: 'Sign in to order items, view pricing, add products to your cart, manage your rewards points, and more. By signing in, you’ll have access to all the features and benefits our platform provides for a personalized shopping experience.',
    usernameF: 'Username:',
    passwordF: 'Password:',
  ...
  es: {
    ...
    // checkout
    disclaimer: '※ Demostración TSA, por favor usa la siguiente información:',
    cardNumberD: 'Número de Tarjeta:',
    expirationD: 'Fecha de Expiración:',
    sec: 'CVV:',
    paymentDetails: 'Detalles de Pago',
    cardNumber: 'Número de Tarjeta',
    expiration: 'Fecha de Expiración (MM/AA)',
    expHolder: 'MM/AA',
    cvv: 'CVV',
    cvc: 'CVC',
    address: 'Dirección',
    ...
    sp: 'Estado/Provincia',
    tax: 'Impuesto (8.5%)',
    regionError: 'Actualmente solo ofrecemos entrega dentro del estado de Washington.',
    pay: 'Pagar',
    ...
    estDelivery: 'Tiempo Estimado de Entrega:',
    ...
    aboutDesc: 'En Green Bites, creemos en nutrir el cuerpo y el alma. Seleccionamos los ingredientes más frescos, celebramos los productos de temporada y creamos platos basados en plantas llenos de sabor. Cada bocado apoya a nuestros agricultores locales, esfuerzos sostenibles y un planeta más saludable.',
    aboutDesc2: 'Únete a nosotros y redefine tu alimentación una comida a la vez.',
    sustainabilityHeader: 'Comprometidos con la Sostenibilidad',
    sustainabilityDesc: 'Desde la granja hasta la mesa, nos aseguramos de que cada ingrediente se obtenga de manera ética y minimice el procesamiento. Nuestro compromiso con la gestión ambiental está intrínsecamente ligado a nuestras creaciones culinarias. Únete a nosotros en un viaje hacia un futuro más verde y saludable—mientras disfrutas de comidas deliciosas.',
    featuredHeader: 'Platos Destacados',
    testimonialsHeader: 'Testimonios de Clientes',
    testimonialsP1: '“¡Los tacos veganos aquí son increíbles! La frescura de los ingredientes y la combinación perfectamente equilibrada de sabores son inigualables. Cada bocado es una explosión de sabor que me deja con ganas de más. Nunca pensé que la comida basada en plantas podría ser tan satisfactoria.”',
    testimonialsPer1: '- Alex Johnson',
    testimonialsP2: '“Green Bites ha redefinido por completo lo que significa la alimentación sostenible. Su dedicación para apoyar a los agricultores locales y utilizar prácticas ecológicas es admirable. Además, la comida es excepcional—cada plato es como una celebración de los mejores ingredientes que la naturaleza ofrece. Siempre salgo satisfecho y con el estómago lleno.”',
    testimonialsPer2: '- Maria Smith',
    testimonialsP3: '“Antes de probar Green Bites, tenía mis dudas sobre las comidas basadas en plantas. Pero sus platos son una revolución. La creatividad en las recetas y la audacia en los sabores son insuperables. Es asombroso ver cómo transforman ingredientes simples y saludables en obras maestras culinarias. ¡Recomiendo encarecidamente a todos, veganos o no!”',
    testimonialsPer3: '- David Lee',
    tDisclaimer: 'Descargo de responsabilidad: Estas personas no existen, estas citas son creadas exclusivamente para fines de concurso.',
    bannerHeader: '¿Listo para una Experiencia Diferente?',
    bannerP: 'Visítanos ahora o realiza un pedido en línea para disfrutar de los regalos de la naturaleza.',
    bannerLink: '¡Ordena Ahora!',
  
    // menu
    menuSub: 'Explora nuestras creaciones—presta atención a cuáles son veganas y cuáles son vegetarianas.',
    menuTooltip: 'Inicia sesión para desbloquear funciones de pedido y entrega',
    addCart: 'Añadir al Carrito',
    added: '¡Añadido!',
  
    // accessibility
    aTitle1: 'Nuestro Compromiso',
    aContent1: 'En Green Bites, nos comprometemos a hacer que nuestro sitio web sea accesible para todos, incluyendo personas con discapacidades. Continuamente trabajamos para mejorar la accesibilidad y usabilidad del sitio, cumpliendo con los estándares de la industria. Creemos que, independientemente de las capacidades, todas las personas deberían tener acceso equitativo a la información y los servicios.',
    aTitle2: 'Estándares y Directrices',
    aContent2: 'Nuestro sitio web está diseñado y desarrollado de acuerdo con las Pautas de Accesibilidad al Contenido Web (WCAG) 2.1, con el objetivo de alcanzar el cumplimiento del nivel AA. Realizamos auditorías y pruebas regulares del sitio para identificar y corregir cualquier barrera de accesibilidad.',
    aTitle3: 'Comentarios y Asistencia',
    aContent3_1: 'Si encuentras alguna barrera de accesibilidad o necesitas asistencia, por favor contacta con nuestro',
    aContent3_2: '.',
  
    // apn
    apnTitle1: 'Información que Recopilamos',
    apnContent1: 'Cuando aplicas para un puesto en Green Bites, recopilamos tu información personal como nombre, información de contacto, currículum, carta de presentación y cartas de recomendación. También podemos recopilar información adicional, incluyendo información de verificación de antecedentes y registros de comunicación durante el proceso de contratación.',
    apnTitle2: 'Cómo Usamos los Datos de los Candidatos',
    apnContent2: 'Los datos de los candidatos se utilizan únicamente para evaluar calificaciones, realizar entrevistas, evaluar la idoneidad para el empleo y comunicarse sobre oportunidades laborales. A menos que solicites su eliminación, podemos mantener tus datos para futuras vacantes.',
    apnTitle3: 'Almacenamiento y Seguridad de Datos',
    apnContent3: 'Tus datos serán almacenados de forma segura y solo serán accesibles para personal autorizado. Mantendremos tu información durante un período razonable para cumplir con obligaciones legales y gestionar eficazmente el proceso de contratación.',
    apnTitle4: 'Tus Derechos',
    apnContent4_1: 'Como candidato, tienes el derecho de acceder, corregir o solicitar la eliminación de tu información personal. Por favor, contacta con nuestro',
    apnContent4_2: ' para cualquier consulta o solicitud relacionada con tus datos.',
  
    // privacy policy
    privacyContent1: 'Recopilamos la información personal que proporcionas, como nombre, correo electrónico y detalles de pago. Además, recopilamos datos no personales a través de herramientas analíticas, como direcciones IP, tipo de navegador y actividad en el sitio web.',
    privacyTitle2: 'Cómo Usamos la Información',
    privacyContent2: 'Usamos tu información para procesar transacciones, proporcionar soporte al cliente y mejorar tu experiencia en nuestro sitio web. Esto incluye contenido personalizado y comunicaciones de marketing.',
    privacyTitle3: 'Cómo Compartimos Tu Información',
    privacyContent3: 'Tu información puede ser compartida con terceros de confianza, como procesadores de pagos y plataformas de marketing, para completar servicios. Aseguramos que todos los socios cumplan con las regulaciones de privacidad.',
    privacyTitle4: 'Tus Derechos de Datos',
    privacyContent4_1: 'Tienes el derecho de acceder, modificar o eliminar tu información personal. Por favor, contacta con nuestro',
    privacyContent4_2: ' para presentar cualquier solicitud.',
  
    // terms of use
    touTitle1: 'Aceptación de Términos',
    touContent1: 'Al acceder o utilizar nuestro sitio web, aceptas cumplir con estos términos y condiciones. Si no estás de acuerdo, por favor detén el uso de nuestros servicios inmediatamente.',
    touTitle2: 'Responsabilidades del Usuario',
    touContent2: 'Los usuarios son responsables de asegurarse de que sus acciones cumplen con las leyes aplicables. Cualquier abuso, incluyendo intentos de dañar nuestra plataforma, está estrictamente prohibido.',
    touTitle3: 'Limitación de Responsabilidad',
    touContent3: 'Green Bites no se responsabiliza por daños derivados del uso de nuestro sitio web, incluyendo pero no limitado a interrupciones del servicio o pérdida de datos.',
    touTitle4: 'Cambios en los Términos',
    touContent4: 'Podemos actualizar estos términos regularmente. Continuar utilizando el sitio después de que se actualice indica tu aceptación de los términos revisados.',
  
    // process
    processT1: 'Prácticas Agrícolas Éticas',
    processD1: 'Nuestra red de agricultores locales adopta prácticas sostenibles y ecológicas que minimizan el impacto ambiental mientras maximizan la nutrición y el sabor. Seleccionamos cuidadosamente a cada socio basado en su compromiso con métodos de agricultura orgánica y la salud del suelo.',
    processT2: 'Procesamiento Rápido y Limpio',
    processD2: 'Horas después de la cosecha, nuestros ingredientes son procesados cuidadosamente en instalaciones de última generación. Esta línea de tiempo rápida asegura la máxima retención de nutrientes y que cada comida que preparamos está llena del sabor más fresco.',
    processT3: 'Embalaje y Distribución Ecológica',
    processD3: 'Hemos revolucionado nuestro proceso de distribución con embalajes 100% compostables y rutas de entrega con compensación de carbono. Nuestra innovadora tecnología de enfriamiento mantiene la frescura de los alimentos mientras minimiza el impacto ambiental.',
    processT4: 'Comidas Frescas y Deliciosas',
    processD4: 'El punto culminante de nuestro proceso es una comida nutritiva y cuidadosamente preparada por chefs que no solo sabe increíble, sino que también es buena para ti y el planeta. Cada plato está meticulosamente creado para ofrecer un equilibrio perfecto de sabor y nutrición.',
    processHTitle: 'De la Granja a tu Mesa',
    processHDesc: 'Experimenta el viaje de tus alimentos desde granjas locales hasta tu plato. Mantenemos los más altos estándares de calidad y sostenibilidad en cada paso, asegurando que recibas comidas no solo deliciosas sino también nutritivas.',
    ...
    whySIHelp: 'Al iniciar sesión, puedes ordenar productos, ver precios, añadir productos al carrito, gestionar tus puntos de recompensa, entre otros. Iniciar sesión te permite acceder a todas las funciones y ventajas que ofrece nuestra plataforma, disfrutando de una experiencia de compra personalizada.',
    usernameF: 'Nombre de Usuario:',
    passwordF: 'Contraseña:',
  ...
  ch: {
    ...
    sp: '州/地区',
    tax: '税费 (8.5%)',
    regionError: '目前我们不支持向华盛顿州以外的地区配送。',
    pay: '支付',
    ...
    // footer
    copyright: '© 2024 绿味坊。未经许可禁止转载。',
    comingSoon: '敬请期待！',

    // home
    title: '欢迎！',
    subTitle: '新鲜、可持续且美味的纯素和素食料理。',
    menuCTA: '查看菜单',
    aboutHeader: '我们的理念',
    aboutDesc: '在绿味坊，我们相信滋养身体和心灵。我们采购最鲜嫩的食材，庆祝应季食材，创造风味丰富的植物性料理。每一口都支持本地农户、可持续发展和更健康的地球。',
    aboutDesc2: '与我们一起，一餐一餐地重新定义您的饮食。',
    sustainabilityHeader: '可持续发展的承诺',
    sustainabilityDesc: '从农场到餐桌。我们确保所有食材都经过道德采购，并经过最少的加工。加入我们的环保努力，与我们一同踏上更绿、更健康的未来之旅。尝一口，您就会感受到不同。',
    featuredHeader: '精选菜品',
    testimonialsHeader: '客户评价',
    testimonialsP1: '“这里的纯素玉米卷真的很棒！新鲜的食材与完美调和的口味组合是我以前从未体验过的。每一口都充满满足感，让我想吃更多。我没想到植物性饮食可以如此令人满意。”',
    testimonialsPer1: '- 亚历克斯·约翰逊',
    testimonialsP2: '“绿味坊彻底重新定义了可持续饮食的概念。支持本地农户并采取环保措施的态度真是值得赞赏。而且，菜品也很棒，每道菜都像是在庆祝自然最好的食材。每次用餐都让我感到心暖且满足。”',
    testimonialsPer2: '- 玛丽亚·史密斯',
    testimonialsP3: '“我对植物性饮食持怀疑态度，但尝试了绿味坊后，我的想法改变了。料理的创造力和大胆的味道无与伦比。看到简单、健康的食材如何转变为烹饪杰作，真是令人惊讶。我强烈推荐给任何人，无论是纯素食者还是非纯素食者！”',
    testimonialsPer3: '- 大卫·李',
    tDisclaimer: '免责声明：这些人物不存在。这些引用是为比赛目的创建的。',
    bannerHeader: '准备好体验不同了吗？',
    bannerP: '立即访问我们的店铺或在线订购，享受大自然带来的美味。',
    bannerLink: '立即订购',

    // menu
    menuSub: '查看我们的菜品——请注意纯素和素食的区别。',
    menuTooltip: '请登录以使用订单和配送服务',
    addCart: '加入购物车',
    added: '已添加！',

    // accessibility
    aTitle1: '我们的承诺',
    aContent1: '在绿味坊，我们承诺让所有人，包括残障人士，都能使用我们的网站。我们致力于根据行业标准提高无障碍性和可用性。我们相信，无论能力如何，每个人都应平等地访问信息和服务。',
    aTitle2: '标准和指南',
    aContent2: '我们的网站设计和开发遵循《Web内容无障碍指南》（WCAG）2.1，旨在达到AA级别。我们定期进行审计和测试，以识别并修复无障碍障碍。',
    aTitle3: '反馈和支持',
    aContent3_1: '如果您在使用过程中遇到无障碍问题或需要帮助，请',
    aContent3_2: '联系我们。我们重视您的反馈，并致力于改善您在我们网站上的体验。',

    // apn
    apnTitle1: '收集的信息',
    apnContent1: '在申请绿味坊时，我们会收集您的个人信息，包括姓名、联系方式、简历、求职信、推荐信等。我们可能还会收集背景调查信息和在招聘过程中与您沟通的记录等额外详细信息。',
    apnTitle2: '申请者数据的使用方式',
    apnContent2: '申请者数据仅用于评估资格、进行面试、评估雇佣适应性以及与雇佣机会相关的沟通。除非有删除请求，我们可能会保留数据以备将来的职位空缺。',
    apnTitle3: '数据的存储和安全',
    apnContent3: '您的数据将被安全存储，仅限授权人员访问。我们将根据法律义务保留数据，并为有效管理招聘流程保留合理期限。',
    apnTitle4: '您的权利',
    apnContent4_1: '作为申请者，您有权要求访问、修改或删除您的个人信息。有关数据的查询或请求，请',
    apnContent4_2: '联系我们。',

    // privacy policy
    privacyContent1: '我们会收集您提供的个人信息，如姓名、电子邮件地址、支付详情等。此外，我们还通过分析工具收集非个人数据，如IP地址、浏览器类型、网站活动等。',
    privacyTitle2: '信息的使用方式',
    privacyContent2: '您的信息将用于处理交易、提供客户支持、改善网站体验。这包括个性化内容和营销沟通。',
    privacyTitle3: '信息的共享',
    privacyContent3: '您的信息可能会与支付处理商和营销平台等可信的第三方共享。我们确保这些第三方遵守隐私法律。',
    privacyTitle4: '您的数据权利',
    privacyContent4_1: '您有权要求访问、修改或删除您的个人信息。有关这些请求的查询，请',
    privacyContent4_2: '联系我们。',

    // terms of use
    touTitle1: '使用条款的同意',
    touContent1: '通过访问或使用本网站，您同意遵守这些使用条款。如果不同意，请立即停止使用我们的服务。',
    touTitle2: '用户责任',
    touContent2: '用户有责任确保其行为符合适用法律。禁止任何损害我们平台的恶意使用。',
    touTitle3: '责任限制',
    touContent3: '绿味坊不对因使用本网站而导致的任何损害负责，包括服务中断或数据丢失。',
    touTitle4: '使用条款的变更',
    touContent4: '这些使用条款可能会定期更新。继续使用本网站即表示您同意修订后的条款。',
    
    // process
    processT1: '伦理农业实践',
    processD1: '我们网络中的本地农户采用可持续和环保的方法，最大限度地减少对环境的影响，同时最大限度地提升营养和风味。我们根据有机农业方法和对土壤健康的承诺，谨慎选择每一个合作伙伴。',
    processT2: '快速且清洁的处理',
    processD2: '食材在收获后数小时内在最先进的设施中精心处理。这一快速的时间表确保最大限度地保持营养素，并保证我们准备的每一道餐点都保持最新鲜的风味。',
    processT3: '环保包装和配送',
    processD3: '我们通过100%可堆肥包装和碳中和配送路线彻底改善了配送流程。创新的冷却技术在最小化环境影响的同时，保持食品的新鲜。',
    processT4: '新鲜美味的餐点',
    processD4: '我们流程的集大成是营养丰富且由厨师精心制作的餐点，不仅味道出众，而且对您和地球都有益。每道菜都经过深思熟虑，以提供完美平衡的风味和营养。',
    processHTitle: '从农场到餐桌',
    processHDesc: '体验食物从本地农场到您餐桌的旅程。我们在每一步都保持最高标准，确保最高质量和可持续性，同时提供尽可能美味和营养丰富的餐点。',
    ...
    pw: '密码',
    whySI: '为什么要登录？',
    whySIHelp: '登录后，您可以下订单、查看价格、将商品添加到购物车以及管理奖励积分。登录后，您可以访问我们平台的所有功能和优势，享受个性化的购物体验。',
    usernameF: '用户名:',
    passwordF: '密码:',
  ...
  tw: {
    ...
    menuCTA: '探索我們的菜單',
    aboutHeader: '我們的理念',
    aboutDesc: '在 Green Bites，我們相信滋養身心靈。我們採購最鮮嫩的農產品，慶祝當季食材，並創造充滿風味的植物性料理。每一口食物都支持我們的本地農民、可持續發展的努力以及更健康的地球。',
    aboutDesc2: '加入我們，一餐一餐地重新定義我們的飲食方式。',
    sustainabilityHeader: '致力於可持續發展',
    sustainabilityDesc: '從農場到餐桌，我們確保每一種食材都經過倫理採購並且最小化加工。我們對環境管理的承諾與我們的烹飪創作密切相關。加入我們，踏上通往更綠色、更健康未來的旅程——一餐美味的食物接一餐。',
    featuredHeader: '推薦料理',
    testimonialsHeader: '顧客評價',
    testimonialsP1: '「這裡的純素塔可真是絕妙！新鮮食材與完美平衡的風味組合讓我前所未有。每一口都是美味的爆發，讓人欲罷不能。我從未想過植物性食物能如此滿足。」',
    testimonialsPer1: '- Alex Johnson',
    testimonialsP2: '「Green Bites 徹底重新定義了可持續飲食的意義。他們對支持本地農民和使用環保做法的奉獻精神令人欽佩。而且，食物也非常出色——每一道菜都像是在慶祝大自然最優質的食材。我每次都帶著滿足的心情和飽滿的肚子離開。」',
    testimonialsPer2: '- Maria Smith',
    testimonialsP3: '「在嘗試 Green Bites 之前，我對植物性餐點持懷疑態度。但他們的菜餚真是一次革新！食譜的創意和風味的大膽無與倫比。看到他們如何將簡單、健康的食材變成烹飪傑作，真是太驚人了。強烈推薦給所有人，無論是否純素！」',
    testimonialsPer3: '- David Lee',
    tDisclaimer: '免責聲明：這些人不存在，這些引述純屬比賽用途創作。',
    bannerHeader: '準備好體驗不同了嗎？',
    bannerP: '立即訪問我們或在線訂購，品嚐大自然的饋贈。',
    bannerLink: '立即訂購',

    // menu
    menuSub: '探索我們的創作——請注意哪些是純素的，哪些是素食的。',
    menuTooltip: '請登入以解鎖訂購和配送功能',
    addCart: '加入購物車',
    added: '已加入！',

    // accessibility
    aTitle1: '我們的承諾',
    aContent1: '在 Green Bites，我們致力於讓我們的網站對所有人，包括殘障人士，都能夠無障礙使用。我們不斷努力提升網站的可訪問性和可用性，符合行業標準。我們相信，無論能力如何，每個人都應該平等地獲取信息和服務。',
    aTitle2: '標準與指南',
    aContent2: '我們的網站按照網頁內容無障礙指導方針（WCAG）2.1設計和開發，目標達到 AA 級合規。我們定期審核和測試網站，以識別並修正任何無障礙障礙。',
    aTitle3: '反饋與協助',
    aContent3_1: '如果您遇到任何無障礙障礙或需要協助，請聯繫我們的',
    aContent3_2: '。我們重視您的反饋，致力於改善您在我們網站上的體驗。',

    // apn
    apnTitle1: '我們收集的信息',
    apnContent1: '當您申請 Green Bites 的職位時，我們會收集您的個人信息，如姓名、聯絡方式、履歷、求職信和推薦信。我們還可能收集其他詳細信息，包括背景調查信息和招聘過程中的通信記錄。',
    apnTitle2: '我們如何使用應聘者數據',
    apnContent2: '應聘者數據僅用於評估資格、進行面試、評估雇用適合性以及就就業機會進行溝通。除非您要求刪除，否則我們可能會保留您的數據以備將來的職位空缺。',
    apnTitle3: '數據保存與安全',
    apnContent3: '您的數據將被安全存儲，僅限授權人員訪問。我們會保留您的信息一段合理的時間，以遵守法律義務並有效管理招聘流程。',
    apnTitle4: '您的權利',
    apnContent4_1: '作為應聘者，您有權訪問、修正或請求刪除您的個人信息。請聯繫我們的',
    apnContent4_2: '以了解有關您數據的查詢或請求。',

    // privacy policy
    privacyContent1: '我們收集您提供的個人信息，如姓名、電子郵件和支付詳細信息。此外，我們通過分析工具收集非個人數據，如IP地址、瀏覽器類型和網站活動。',
    privacyTitle2: '我們如何使用信息',
    privacyContent2: '我們使用您的信息來處理交易、提供客戶支持並提升您在我們網站上的體驗。這包括個性化內容和營銷通信。',
    privacyTitle3: '我們如何共享您的信息',
    privacyContent3: '您的信息可能會與可信的第三方共享，如支付處理商和營銷平台，以完成服務。我們確保所有合作方遵守隱私法規。',
    privacyTitle4: '您的數據權利',
    privacyContent4_1: '您有權訪問、修改或刪除您的個人信息。請聯繫我們的',
    privacyContent4_2: '以提出任何請求。',

    // terms of use
    touTitle1: '接受條款',
    touContent1: '通過訪問或使用我們的網站，您同意遵守這些條款和條件。如果您不同意，請立即停止使用我們的服務。',
    touTitle2: '用戶責任',
    touContent2: '用戶有責任確保其行為符合法律規定。任何濫用，包括試圖損害我們的平台，均被嚴格禁止。',
    touTitle3: '責任限制',
    touContent3: 'Green Bites 對於因使用我們的網站而產生的損害不承擔任何責任，包括但不限於服務中斷或數據丟失。',
    touTitle4: '條款變更',
    touContent4: '我們可能會定期更新這些條款。網站更新後的繼續使用表示您接受修訂後的條款。',

    // process
    processT1: '倫理農業實踐',
    processD1: '我們的本地農民網絡採用可持續、環保的實踐，最大限度地減少環境影響，同時最大化營養和風味。我們根據他們對有機農業方法和土壤健康的承諾，仔細選擇每一位合作夥伴。',
    processT2: '快速清潔的處理',
    processD2: '在收穫後數小時內，我們的食材在最先進的設施中被仔細處理。這一迅速的時間表確保了營養素的最大保留和我們準備的每一餐都擁有最鮮嫩的風味。',
    processT3: '環保包裝與配送',
    processD3: '我們通過100%可堆肥包裝和碳中和的配送路線，徹底革新了我們的配送過程。我們的創新冷卻技術在最大限度地減少環境影響的同時，保持食品的新鮮。',
    processT4: '新鮮美味的餐點',
    processD4: '我們流程的終點是營養豐富、由廚師精心製作的餐點，這些餐點不僅味道出色，對您和地球都有益。每一道菜都經過精心創作，提供完美平衡的風味和營養。',
    processHTitle: '從農場到您的餐桌',
    processHDesc: '體驗您的食物從本地農場到您的盤子的旅程。我們在每一個環節都保持最高的質量和可持續性標準，確保您獲得最美味和營養豐富的餐點。',
    ...
    pw: '密碼',
    whySI: '為什麼要登入？',
    whySIHelp: '登入後，您可以訂購商品、查看價格、將產品加入購物車、管理您的獎勵積分等。通過登入，您將能夠訪問我們平台提供的所有功能和優勢，享受個性化的購物體驗。',
    usernameF: '用戶名:',
    passwordF: '密碼:',
  ...
  jp: {
    ...
    sp: '州/地域',
    tax: '税金 (8.5%)',
    regionError: '現在、WA州以外への配送には対応しておりません。',
    pay: '支払う',
    unsupportedRegion: '非対応地域',
    ...
    // footer
    copyright: '© 2024 グリーンバイツ。無断転載禁止。',
    comingSoon: '近日公開！',
  
    // home
    title: 'ようこそ！',
    subTitle: '新鮮で持続可能、そしておいしいヴィーガン・ベジタリアン料理。',
    menuCTA: 'メニューを見る',
    aboutHeader: '私たちの理念',
    aboutDesc: 'グリーンバイツでは、体と心の両方を養うことを信条としています。私たちは最も新鮮な食材を調達し、旬の素材を祝福し、風味豊かな植物由来の料理を作り出しています。お客様が一口食べるごとに、地域農家、持続可能性への取り組み、そしてより健康的な地球を支えています。',
    aboutDesc2: '私たちと一緒に、一食ずつ食生活を再定義しましょう。',
    sustainabilityHeader: '持続可能性への取り組み',
    sustainabilityDesc: '農場から食卓へ。私たちはすべての食材が倫理的に調達され、最小限の加工が施されていることを保証しています。環境保護への取り組みと料理の創作は手を取り合い、よりグリーンで健康的な未来への旅に参加してください。一度食べればその違いがわかります。',
    featuredHeader: 'おすすめ料理',
    testimonialsHeader: 'お客様の声',
    testimonialsP1: '「ここのヴィーガンタコスは本当に素晴らしいです！新鮮な食材と完璧に調和した味わいの組み合わせは、これまで体験したことがないものでした。一口一口が満足感でいっぱいで、もっと食べたくなります。植物由来の食事がこれほど満足できるとは思いませんでした。」',
    testimonialsPer1: '- アレックス・ジョンソン',
    testimonialsP2: '「グリーンバイツは、持続可能な食事の概念を完全に再定義しました。地元農家を支援し、環境に配慮した取り組みを行っている姿勢は本当に賞賛に値します。その上、料理も素晴らしく、どの料理も自然の最高の食材を祝うかのようです。毎回、心が温まり、お腹も満たされます。」',
    testimonialsPer2: '- マリア・スミス',
    testimonialsP3: '「植物由来の食事には懐疑的でしたが、グリーンバイツを試してみてその考えが変わりました。料理の創造性や大胆な味わいは他に類を見ません。シンプルで健康的な食材をどのようにして料理の傑作に変えるのかを目の当たりにできるのは本当に驚きです。ヴィーガンでもそうでなくても、誰にでもお勧めします！」',
    testimonialsPer3: '- デイビッド・リー',
    tDisclaimer: '免責事項：これらの人物は実在しません。この引用はコンテスト用に作成されました。',
    bannerHeader: '違いを体験する準備はできていますか？',
    bannerP: '今すぐお店を訪れるかオンラインで注文して、自然がもたらす味を楽しんでください。',
    bannerLink: '今すぐ注文',
  
    // menu
    menuSub: '私たちの料理をご覧ください—ヴィーガンとベジタリアンの違いにご注意ください。',
    menuTooltip: '注文と配達を利用するにはサインインしてください',
    addCart: 'カートに追加',
    added: '追加済み！',
  
    // accessibility
    aTitle1: '私たちの取り組み',
    aContent1: 'グリーンバイツでは、障害を持つ個人を含め、誰もがウェブサイトを利用できるようにすることをお約束します。業界標準に従ってアクセシビリティと使いやすさを向上させるよう努めています。能力に関係なく、すべての人が情報やサービスに平等にアクセスできることを信じています。',
    aTitle2: '基準とガイドライン',
    aContent2: '当ウェブサイトは、Webコンテンツアクセシビリティガイドライン（WCAG）2.1に準拠して設計・開発されており、レベルAA準拠を目指しています。定期的に監査やテストを行い、アクセシビリティの障害を特定し修正します。',
    aTitle3: 'フィードバックと支援',
    aContent3_1: 'アクセシビリティの障害に遭遇したり、支援が必要な場合は',
    aContent3_2: 'までご連絡ください。お客様からのフィードバックを大切にし、ウェブサイトでの体験を向上させるために努めます。',
  
    // apn
    apnTitle1: '収集する情報',
    apnContent1: 'グリーンバイツに応募する際には、名前、連絡先情報、履歴書、カバーレター、推薦状などの個人情報を収集します。また、バックグラウンドチェック情報や採用プロセス中のコミュニケーション記録など、追加の詳細を収集する場合があります。',
    apnTitle2: '応募者データの使用方法',
    apnContent2: '応募者データは、資格の評価、面接の実施、雇用の適性評価、および雇用機会に関するコミュニケーションのためにのみ使用されます。削除のリクエストがない限り、将来の求人に備えてデータを保持する場合があります。',
    apnTitle3: 'データの保管とセキュリティ',
    apnContent3: 'お客様のデータは安全に保管され、許可された担当者のみがアクセスします。法的義務を遵守し、採用プロセスを効果的に管理するために、合理的な期間データを保持します。',
    apnTitle4: 'お客様の権利',
    apnContent4_1: '応募者として、個人情報へのアクセス、修正、または削除を要求する権利があります。データに関連するお問い合わせやリクエストは、',
    apnContent4_2: 'までご連絡ください。',
  
    // privacy policy
    privacyContent1: '私たちは、お客様が提供する名前、メールアドレス、支払い詳細などの個人情報を収集します。さらに、IPアドレス、ブラウザの種類、サイトのアクティビティなどの非個人データを分析ツールを通じて収集します。',
    privacyTitle2: '情報の使用方法',
    privacyContent2: 'お客様の情報は、取引の処理、カスタマーサポートの提供、ウェブサイトでの体験の向上に使用されます。これには、コンテンツやマーケティングコミュニケーションのパーソナライズが含まれます。',
    privacyTitle3: '情報の共有',
    privacyContent3: 'お客様の情報は、支払い処理業者やマーケティングプラットフォームなどの信頼できる第三者と共有される場合があります。これらの第三者がプライバシー法を遵守することを保証します。',
    privacyTitle4: 'お客様のデータ権利',
    privacyContent4_1: 'お客様は、個人情報へのアクセス、修正、削除を要求する権利があります。これらのリクエストに関するお問い合わせは',
    privacyContent4_2: 'までご連絡ください。',
  
    // terms of use
    touTitle1: '利用規約の承諾',
    touContent1: '当ウェブサイトへのアクセスまたは利用により、これらの利用規約に従うことに同意したものとみなされます。同意しない場合は、直ちにサービスの利用を中止してください。',
    touTitle2: 'ユーザーの責任',
    touContent2: 'ユーザーは、自身の行動が適用法令に準拠していることを確認する責任があります。当プラットフォームを害する試みを含む不正使用は厳禁です。',
    touTitle3: '責任の制限',
    touContent3: 'グリーンバイツは、サービスの中断やデータ損失など、当ウェブサイトの利用から生じる損害について責任を負いません。',
    touTitle4: '利用規約の変更',
    touContent4: 'これらの利用規約は、定期的に更新されることがあります。更新後もウェブサイトを継続して利用することで、改訂された規約に同意したものとみなされます。',
  
    // process
    processT1: '倫理的な農業慣行',
    processD1: '私たちのネットワークに所属する地元農家は、環境への影響を最小限に抑えつつ、栄養と風味を最大限に引き出す持続可能でエコフレンドリーな方法を採用しています。私たちは、有機農業方法と土壌の健康に対するコミットメントに基づいて各パートナーを慎重に選定しています。',
    processT2: '迅速でクリーンな処理',
    processD2: '収穫後数時間以内に、私たちの食材は最先端の施設で慎重に処理されます。この迅速なタイムラインにより、栄養素の保持が最大化され、私たちが準備するすべての食事において最も新鮮な風味が保証されます。',
    processT3: 'エコフレンドリーなパッケージングと配送',
    processD3: '私たちは100%堆肥化可能なパッケージングとカーボンニュートラルな配送ルートで配送プロセスを革命的に改善しました。革新的な冷却技術により、環境への影響を最小限に抑えつつ、食品の新鮮さを維持します。',
    processT4: '新鮮でおいしい食事',
    processD4: '私たちのプロセスの集大成は、栄養価が高くシェフが手掛けた食事で、味だけでなく、あなたと地球のためにも良いものです。各料理は、風味と栄養素の完璧なバランスを提供するよう考え抜かれています。',
    processHTitle: '農場から食卓へ',
    processHDesc: '地元農場からあなたの食卓までの食品の旅を体験してください。私たちは、最高の品質と持続可能性を維持しながら、すべてのステップで最高基準を維持し、可能な限りおいしく栄養豊富な食事を提供します。',
    ...
    pw: 'パスワード',
    whySI: 'なぜサインインするのか？',
    whySIHelp: 'サインインすると、商品を注文したり、価格を表示したり、カートに商品を追加したり、報酬ポイントを管理したりすることができます。サインインすることで、パーソナライズされたショッピング体験を提供する当社のプラットフォームのすべての機能と利点にアクセスできます。',
    usernameF: 'ユーザー名:',
    passwordF: 'パスワード:',
