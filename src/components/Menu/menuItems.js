...
const menuItems = [
...

  {
    id: 5,
    name: 'Vegan Pizza',
    description: 'A crispy thin crust topped with marinara, vegan cheese, mushrooms, and spinach.',
    image: pizza,
...

  {
    ...
    description: 'Creamy, cheesy, and comforting made from cashews, nutritional yeast, and turmeric.',
    image: mc,
...

  {
    id: 8,
    name: 'Chickpea Curry',
    description: 'A warm, aromatic curry made with chickpeas, coconut milk, and a blend of spices.',
    image: curry,
...

  {
    ...
    nutritionalInfo: 'Each bowl provides approximately 400 kcal, with 12g of protein, 9g of fiber, and 15g of healthy fats. It’s a good source of vitamin C (from bell peppers and lime), potassium (from zucchini and avocado), and iron (from black beans). The burrito bowl is satisfying, customizable, and entirely plant-based.',
    allergens: [
...

  {
    ...
    description: 'Skewers of marinated zucchini, bell peppers, onions, and mushrooms.',
    image: kabob,
...

  {
    id: 11,
    name: 'Vegan Stir Fry',
    description: 'A mix of fresh vegetables stir-fried in a savory soy-based sauce, served over jasmine rice.',
    image: stirfry,
...

  {
    ...
    description: 'Sushi rolls with avocado, cucumber, and pickled radish, served with soy sauce.',
    image: sushi,
...

  {
    ...
    description: 'Soft tortillas filled with roasted sweet potatoes, black beans, avocado, and slaw.',
    image: staco,
    ...
    nutritionalInfo: 'Each taco provides approximately 280 kcal, with 8g of protein, 6g of fiber, and 10g of healthy fats. It is rich in vitamin A (from sweet potatoes), vitamin C (from cabbage and lime), and potassium (from avocado). A colorful, nutrient-packed meal that is both flavorful and wholesome.',
    allergens: [
...

  {
    ...
    description: 'A crispy tortilla filled with vegan cheese, beans, and sautéed vegetables.',
    image: quesadillas,
...

  {
    id: 15,
    name: 'Lentil Soup',
    description: 'A hearty soup made with lentils, carrots, celery, and tomatoes.',
    image: soup,
    ...
    nutritionalInfo: 'Each serving provides approximately 250 kcal, with 12g of protein, 8g of fiber, and 4g of healthy fats. The soup is rich in iron (from lentils and spinach), vitamin A (from carrots and spinach), and potassium (from potatoes). It’s light, nourishing, and perfect for a healthy meal.',
    allergens: [
